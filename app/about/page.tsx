...
export default function AboutContent() {
  ...
  return (
    <>
      ...
      <div
        ref={rootRef}
        className="relative flex flex-col flex-1 items-center bg-[#111010] min-h-screen transition-colors duration-300"
      >
        <div
          aria-hidden
        ...
        <main className="relative z-20 flex flex-1 w-full max-w-5xl flex-col py-14 px-12 lg:px-16">
            ...
            <div className="flex flex-col gap-4">
              {education.map((edu, i) => (
                <motion.div
                  ...
                  className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 p-5 rounded-xl border border-stone-800 bg-stone-900/60 backdrop-blur-sm"
                >
                  <div>
                    <p className="text-[14px] font-medium text-stone-200 leading-snug">
                      {edu.degree}
                    </p>

                    <p className="text-[12.5px] text-stone-400 mb-1.5">
                      {edu.school}
                    </p>

                    <p className="text-[12.5px] font-light leading-[1.8] text-stone-500">
                      {edu.desc}
                    </p>
                  </div>

                  <span className="text-[9.5px] tracking-[0.22em] uppercase text-stone-600 flex-shrink-0 mt-0.5">
                    {edu.period}
                  </span>
                </motion.div>
              ))}
          ...
          <section className="scroll-reveal mb-20 flex flex-col items-center text-center gap-5">
            <p className="text-[10.5px] tracking-[0.36em] uppercase text-stone-600">
              Let's connect
            </p>
            <h2 className="text-[22px] font-normal text-stone-100 leading-snug max-w-md">
              Have an interesting project or just want to chat about tech?
            </h2>
            <p className="text-[13px] font-light text-stone-600 max-w-sm">
              Reach me at{" "}
              <a
                href="mailto:bintangyuda08@gmail.com"
                className="text-stone-400 underline underline-offset-2 hover:text-stone-200 transition-colors"
              >
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-1">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="text-[10px] tracking-[0.26em] uppercase text-stone-600
                    border border-stone-800 px-4 py-2 rounded-lg
                    hover:text-stone-400 hover:border-stone-700
          ...
          <footer className="mt-2 pt-6 border-t border-stone-800/70 flex items-center justify-between pb-32">
            <span className="text-[11px] tracking-[0.22em] uppercase text-stone-700">
